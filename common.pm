...
@EXPORT = qw( INDEX_FILE TEMPLATES_DIR QUERY_URL DOC_PATH_PREFIX USERNAME PASSWORD LOCAL_FS_DOC_PATH_PREFIX MAX_RESULTS_WHEN_GIVING_METADATA MAX_TITLE_LENGTH_BEFORE_TRUNCATION URL_PREFIX MAX_FILE_BROWSER_DIR_DEPTH METADATA_CACHE_DIR );
